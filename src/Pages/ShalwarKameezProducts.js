...
export const SHALWARKAMEEZ_PRODUCTS = [
  {
    id: 1,
    name: "ShalwarKameez Style One",
    price: "Rs 21,990",
    colors: [
  ...
  {
    id: 3,
    name: "ShalwarKameez Style Three",
    price: "Rs 19,990",
    colors: [
